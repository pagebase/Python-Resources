...
try:
    ...
    if user_choice=="Yes".lower():
        ...
        dst=input("Enter destination path: ").strip() # `strip()` method remove white spaces from left side and right side.
    folder_names = ["Photos", "Videos", "Audio", "Documents", "Softwares", "Archives"]
    img_ext_list = [".png", ".jpeg", ".jpg", ".webp", ".gif"]
    vid_ext_list = [".mp4", ".mkv", ".mov", ".wmv"]
    aud_ext_list = [".mp3", ".wav", ".aac"]
    doc_ext_list = [".pdf", ".csv", ".docx", ".pptx", ".txt", ".md", ".torrent", ".xlsx", ".iso"]
