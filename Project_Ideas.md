...
4. [Telegram bot which accept text as input, convert into audio and store in Database and send all stored data to particular platform on specified time and date. This project is good for whose schedule is too bust](#telegram-bot)
